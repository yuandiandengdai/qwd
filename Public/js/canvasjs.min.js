...
(function () {
    ...
    function Ra(a, d) {
        ...
        for (0 > c && (c += b); c < b; c++)if (c in this && this[c] === a)return c;
        return -1
    }
    ...
    function I(a, d) {
        ...
        if (b = {
            ...
            0; c < b.length; c++)b[c] *= d; else b = [];
        return b
    }

    function K(a, d, b, c) {
        if (a.addEventListener) a.addEventListener(d, b, c || !1); else if (a.attachEvent) a.attachEvent("on" + d, function (c) {
            c = c || window.event;
    ...
    function ua(a, d) {
        for (var b = [], c, f = 0; f < a.length; f++)if (0 == f) b.push(a[0]); else {
            var g, h, l;
            l = f - 1;
            g = 0 === l ? 0 : l - 1;
    ...
    function ma(a, d) {
        ...
        if (x(this.options.margin) && a.options.subtitles)for (var b = a.options.subtitles, c = 0; c < b.length; c++)if ((x(b[c].horizontalAlign) && "center" === this.horizontalAlign || b[c].horizontalAlign === this.horizontalAlign) && (x(b[c].verticalAlign) && "top" === this.verticalAlign || b[c].verticalAlign === this.verticalAlign) && !b[c].dockInsidePlotArea === !this.dockInsidePlotArea) {
            this.margin = 0;
            break
        }
    ...
    function B(a, d, b, c, f) {
        ...
        90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle &&
            (this.labelAngle -= 360);
        if (this.options.stripLines && 0 < this.options.stripLines.length)for (this.stripLines = [], d = 0; d < this.options.stripLines.length; d++)this.stripLines.push(new na(this.chart, this.options.stripLines[d], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var z = {}, u = !!document.createElement("canvas").getContext, ca = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        ia = {
        ...
        }, Ka = {}, ba = null, Ea = function () {
            var a = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, d = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), b = "Sun Mon Tue Wed Thu Fri Sat".split(" "), c = "January February March April May June July August September October November December".split(" "),
                f = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), g = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, h = /[^-+\dA-Z]/g;
            return function (l, k, m) {
                var n = m ? m.days : d, p = m ? m.months : c, e = m ? m.shortDays : b, r = m ? m.shortMonths : f;
                m = "";
                var q = !1;
                ...
                m = q ? "getUTC" : "get";
                var s = l[m + "Date"](), v = l[m + "Day"](),
                    w = l[m + "Month"](), y = l[m + "FullYear"](), t = l[m + "Hours"](), u = l[m + "Minutes"](), Z = l[m + "Seconds"](), aa = l[m + "Milliseconds"](), x = q ? 0 : l.getTimezoneOffset();
            ...
            var c = 0 > a ? !0 : !1;
            c && (a *= -1);
            var f = b ? b.decimalSeparator : ".", g = b ? b.digitGroupSeparator : ",", h = "";
            d = String(d);
            var h = 1, l = b = "", k = -1, m = [], n = [], p = 0, e = 0, r = 0, q = !1, s = 0, l = d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            d = null;
            for (var v = 0; l && v < l.length; v++)if (d = l[v], "." === d && 0 > k) k = v; else {
                if ("%" === d) h *= 100; else if ("\u2030" === d) {
                    h *= 1E3;
                    continue
            ...
            a = (d[1] + "").split("");
            h && "0" === h[0] && h.shift();
            for (q = l = v = e = k = 0; 0 < m.length;)if (d = m.pop(), "#" === d || "0" === d)if (k++, k === p) {
                var w = h, h = [];
                if ("0" === d)for (d = p - e - (w ? w.length : 0); 0 < d;)w.unshift("0"), d--;
                for (; 0 < w.length;)b = w.pop() + b, q++, 0 === q % l && (v === r && 0 < w.length) && (b = g + b)
            } else 0 < h.length ? (b = h.pop() + b, e++, q++) : "0" === d && (b = "0" + b, e++, q++), 0 === q % l && (v === r && 0 < h.length) && (b = g + b); else"E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? "," === d ? (v++, l = q, q = 0, 0 < h.length &&
            ...
            return {x: d, y: b}
        }, Ma = !0, za = window.devicePixelRatio || 1, sa = 1, Q = Ma ? za / sa : 1, Aa = window && window.location && window.location.href &&
            window.location.href.indexOf && (-1 !== window.location.href.indexOf("canvasjs.com") || -1 !== window.location.href.indexOf("fiddle")), Ta = {
        ...
        z.fNg = function (a) {
            if (!Aa)try {
                ...
                a:{
                    ...
                    if (f && 0 < f.length || g) {
                        var h, b = [], l = [], k = null;
                        if (f)for (var m = f[0].split("; "), f = 0; f < m.length; f++)b.push(m[f].split("=")[0]), l.push(m[f].split("=")[1]);
                        g && (k = g);
                        ...
                        k = l.getTime();
                        l.setTime(k + 31536E6);
                        var n = {name: z.ckDec(z.str.ckn), val: (new Date).getTime()};
                ...
                if (d) {
                    ...
                    var e = z.ckDec(z.str.tem), r = p.measureText(e).width;
    ...
    M.prototype.set = function (a, d, b) {
        ...
        if ("options" === a) this.createUserOptions(d); else if (c.hasOwnProperty(a) || c.publicProperties && c.publicProperties.hasOwnProperty(a) && "readWrite" === c.publicProperties[a]) this.options._isPlaceholder && this.createUserOptions(), this.options[a] = d; else {
    ...
    M.prototype.removeEventListener = function (a, d) {
        if (a && d && this._eventListeners[a])for (var b = this._eventListeners[a], c = 0; c < b.length; c++)if (b[c].eventHandler === d) {
            b[c].splice(c, 1);
            break
        }
    };
    ...
    A.prototype._initialize = function () {
        ...
        this.data = [];
        var a = 0;
        if (this.options.data)for (var d = 0; d < this.options.data.length; d++)if (a++, !this.options.data[d].type || 0 <= A._supportedChartTypes.indexOf(this.options.data[d].type)) {
    ...
    A.prototype.render = function (a) {
        ...
        for (a = 0; a < this.data.length; a++)if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
            if (!this.data[a].axisYType ||
                ...
                if (!this.axisY.length)for (var b = 0; b < this.options.axisY.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new B(this, this.options.axisY[b], "axisY", "left", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[b] = new B(this, this.options.axisY[b], "axisY", "bottom", b));
            ...
            if ("secondary" === this.data[a].axisYType)if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                if (!this.axisY2.length)for (b = 0; b < this.options.axisY2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new B(this, this.options.axisY2[b], "axisY", "right", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new B(this, this.options.axisY2[b], "axisY", "top", b));
            ...
            if (!this.data[a].axisXType || "primary" === this.data[a].axisXType)if (this.options.axisX && 0 < this.options.axisX.length) {
                if (!this.axisX.length)for (b = 0; b < this.options.axisX.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new B(this, this.options.axisX[b], "axisX", "bottom", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[b] = new B(this, this.options.axisX[b], "axisX", "left", b));
            ...
            if ("secondary" === this.data[a].axisXType)if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                if (!this.axisX2.length)for (b = 0; b < this.options.axisX2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new B(this, this.options.axisX2[b], "axisX", "top", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[b] = new B(this, this.options.axisX2[b], "axisX", "right", b));
        ...
        if (this.options.subtitles)for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)b = new va(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? d.push(b) : b.render();
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) B.setLayoutAndRender(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace()); else if ("none" ===
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)for (var d = this.plotInfo.plotTypes[a], g = 0; g < d.plotUnits.length; g++) {
        ...
        0 < c.length ? (k.disableToolTip = !0, k._animator.animate(200, k.animationDuration, function (a) {
                ...
                c = [];
                for (var a = 0; a < k.plotInfo.plotTypes.length; a++)for (var b = k.plotInfo.plotTypes[a], d = 0; d < b.plotUnits.length; d++)b.plotUnits[d].targetCanvas =
                    null;
                f = null;
                k.disableToolTip = !1
    ...
    A.prototype.categoriseDataSeries = function () {
        for (var a = "", d = 0; d < this.data.length; d++)if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= A._supportedChartTypes.indexOf(a.type)) {
            for (var b = null, c = !1, f = null, g = !1, h = 0; h < this.plotInfo.plotTypes.length; h++)if (this.plotInfo.plotTypes[h].type === a.type) {
                c = !0;
        ...
        for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (b =
    ...
    A.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
            var l = this.data[a.dataSeriesIndexes[h]], k = 0, m = !1, n = !1, p;
            ...
            for (k = 0; k < l.dataPoints.length; k++) {
                ...
                if (c < e && !m) null !== f && (p = c); else {
                    if (!m && (m = !0, 0 < k)) {
                        k -= 2;
                        continue
                    }
                    if (c > r && !n) n = !0; else if (c > r && n)continue;
    ...
    A.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], l = [], k = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                var n = this.data[a.dataSeriesIndexes[m]], p = 0, e = !1, r = !1, q;
                ...
                for (p = 0; p < n.dataPoints.length; p++) {
                    ...
                    if (c < s && !e) null !== n.dataPoints[p].y && (q = c); else {
                        if (!e && (e = !0, 0 < p)) {
                            p -= 2;
                            continue
                        }
                        if (c > v && !r) r = !0; else if (c > v && r)continue;
    ...
    A.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = !1, l = !1, k = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                var n = this.data[a.dataSeriesIndexes[m]], p = 0,
                    e = !1, r = !1, q;
    ...
    A.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var d =
            a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g, h, l = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
            var m = this.data[a.dataSeriesIndexes[k]], n = 0, p = !1, e = !1, r, q, s;
            ...
            for (n = 0; n < m.dataPoints.length; n++) {
                ...
                if (!(c < v) || p) {
                    ...
                    if (c > w && !e) e = !0; else if (c > w && e)continue;
                    m.dataPoints[n].label && (a.axisX.labels[c] = m.dataPoints[n].label);
                    c < b.viewPortMin && (b.viewPortMin = c);
                    c > b.viewPortMax && (b.viewPortMax = c);
                    if (b.viewPortMin === c && f)for (y = 0; y < f.length; y++)if (null === f[y] && r < c) {
                        b.viewPortMin = r;
                        break
                    }
    ...
    A.prototype.getDataPointAtXY = function (a, d, b) {
        ...
        a = null;
        d = !1;
        for (b = 0; b < c.length; b++)if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)if (f =
    ...
    A.prototype.getObjectAtXY = function (a, d, b) {
        var c = null;
        if (b = this.getDataPointAtXY(a, d, b || !1)) c = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (u) c = La(a, d, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) {
            var f =
                this.legend.items[b];
    ...
    A.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < d.length; b++)f = d[b], g = document.createEvent("MouseEvent"),
    ...
    A.prototype._dispatchRangeEvent = function (a, d) {
        ...
        for (var f = 0; f < c.length; f++)if (x(b[c[f]]) && (b[c[f]] = []), "axisY" === c[f])for (var g = 0; g < this.axisY.length; g++)b[c[f]].push({
        ...
        }); else if ("axisY2" === c[f])for (g = 0; g < this.axisY2.length; g++)b[c[f]].push({
            viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum,
            viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum
        }); else if ("axisX" === c[f])for (g = 0; g < this.axisX.length; g++)b[c[f]].push({
            viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum,
            viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum
        }); else if ("axisX2" === c[f])for (g = 0; g < this.axisX2.length; g++)b[c[f]].push({
            viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum,
            viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum
        });
    ...
    A.prototype._mouseEventHandler = function (a) {
        ...
        if (this.interactivityEnabled)if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), !f) {
            if (!A.capturedEventParam && this._events) {
                for (var g = 0; g < this._events.length; g++)if (this._events[g].hasOwnProperty(b))if (c = this._events[g], f = c.bounds, d.x >= f.x1 && d.x <= f.x2 && d.y >= f.y1 && d.y <= f.y2) {
    ...
    A.prototype._plotAreaMouseUp = function (a, d) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if ("xySwapped" === this.plotInfo.axisPlacement)var l = g, g = f, f = l;
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)for (f = g = 0; f < this._axes.length; f++)b =
                    this._axes[f], b.logarithmic ? b.viewportMinimum < b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * g, b.sessionVariables.newViewportMaximum = b.viewportMaximum * g, h = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum / b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum / g, b.sessionVariables.newViewportMaximum = b.viewportMaximum / g, h = !0) : b.viewportMinimum < b.minimum ? (g = b.minimum - b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum +
                            g, b.sessionVariables.newViewportMaximum = b.viewportMaximum + g, h = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum - b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum - g, b.sessionVariables.newViewportMaximum = b.viewportMaximum - g, h = !0); else if ((!f || 2 < Math.abs(c)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) {
    ...
    A.prototype._plotAreaMouseMove = function (a, d) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled) f = {
                x1: f ? this.plotArea.x1 + b : this.plotArea.x1, y1: g ? this.plotArea.y1 + c : this.plotArea.y1,
                x2: f ? this.plotArea.x2 + b : this.plotArea.x2, y2: g ? this.plotArea.y2 + c : this.plotArea.y2
                ...
                this.overlaidCanvasCtx.fillStyle =
                    "#A89896";
                var c = f ? this.dragStartPoint.x : this.plotArea.x1, l = g ? this.dragStartPoint.y : this.plotArea.y1, k = f ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, m = g ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
    ...
    A.prototype._zoomPanToSelectedRegion = function (a, d, b, c, f) {
        ...
        b = a.axesRanges;
        if (a.isValid)for (c = 0; c < d.length; c++)f = b[c], d[c].setViewPortRange(f.val1, f.val2);
        return a.isValid
    };
    A.prototype.validateRegion = function (a, d, b, c, f) {
        ...
        for (g = 0; g < m.length; g++) {
            var h = m[g], p = h.convertPixelToValue({x: a, y: d}), e = h.convertPixelToValue({x: b, y: c});
            if (p > e)var r = e, e = p, p = r;
            if (isFinite(h.dataInfo.minDiff))if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                p < h.minimum || e > h.maximum)) k.push(h), n.push({val1: p, val2: e}), l = !0; else if (!f) {
                l = !1;
                break
            }
        }
        return {isValid: l, axesWithValidRange: k, axesRanges: n}
    };
    ...
    A.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            var m = this._indexLabels[a], n = m.chartType.toLowerCase(),
                p, e, l = L("indexLabelFontColor", m.dataPoint, m.dataSeries), k = L("indexLabelFontSize", m.dataPoint, m.dataSeries);
            p = L("indexLabelFontFamily", m.dataPoint, m.dataSeries);
            e = L("indexLabelFontStyle", m.dataPoint, m.dataSeries);
            var h = L("indexLabelFontWeight", m.dataPoint, m.dataSeries), r = L("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), f = L("indexLabelMaxWidth", m.dataPoint, m.dataSeries), g = L("indexLabelWrap", m.dataPoint, m.dataSeries), q = L("indexLabelLineDashType", m.dataPoint, m.dataSeries), s = L("indexLabelLineColor",
                m.dataPoint, m.dataSeries), v = x(m.dataPoint.indexLabelLineThickness) ? x(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness, c = 0 < v ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, w = {
                percent: null,
                total: null
            }, y = null;
            ...
            if (null !== t && "" !== t) {
                var w = L("indexLabelPlacement", m.dataPoint, m.dataSeries), y = L("indexLabelOrientation", m.dataPoint, m.dataSeries), D = m.direction, Z = m.dataSeries.axisX, aa = m.dataSeries.axisY, z = !1, r = new W(d, {
                    x: 0,
                    y: 0,
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) w = "auto", h = 4; else if (0 <= n.indexOf("stacked")) "auto" === w && (w = "inside"); else if ("bubble" === n || "scatter" === n) w = "inside";
                    p = m.point.x - l / 2;
    ...
    A.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var k = l.dataPoints, m = "solid";
                if (d.setLineDash) {
                    var n =
                        I(l.nullDataLineDashType, l.lineThickness), m = l.lineDashType, p = I(m, l.lineThickness);
                    d.setLineDash(p)
                }
                var e = l.id;
                ...
                var e = l._colorSet, r = e = l.lineColor = l.options.lineColor ? l.options.lineColor : e[0];
                d.strokeStyle = e;
                var q = !0, s = 0, v, w;
                d.beginPath();
                if (0 < k.length) {
                    for (var y = !1, s = 0; s < k.length; s++)if (v = k[s].x.getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                        v > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y)))if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || q) && (d.stroke(), u && b.stroke()), y = !0; else {
    ...
    A.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var k = l.dataPoints, m = "solid";
                if (d.setLineDash) {
                    var n = I(l.nullDataLineDashType, l.lineThickness), m = l.lineDashType, p = I(m, l.lineThickness);
                    d.setLineDash(p)
                }
                var e = l.id;
                this._eventManager.objectMap[e] = {objectType: "dataSeries", dataSeriesIndex: h};
                ...
                if (0 < k.length) {
                    for (var y =
                        !1, s = 0; s < k.length; s++)if (v = k[s].getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y)))if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || q) && (d.stroke(), u && b.stroke()), y = !0; else {
                        var t = w;
                        v = a.axisX.convertValueToPixel(v);
                        w = a.axisY.convertValueToPixel(k[s].y);
    ...
    A.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (b.setLineDash) {
                    var p =
                        I(k.nullDataLineDashType, k.lineThickness), n = k.lineDashType, e = I(n, k.lineThickness);
                    b.setLineDash(e)
                }
                var r = k.id;
                this._eventManager.objectMap[r] = {objectType: "dataSeries", dataSeriesIndex: l};
                r = G(r);
                c.strokeStyle = r;
                c.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0;
                var r = k._colorSet, q = r = k.lineColor = k.options.lineColor ? k.options.lineColor : r[0];
                b.strokeStyle = r;
                var s = 0, v, w, y = [];
                b.beginPath();
                if (0 < m.length)for (w = !1, s = 0; s < m.length; s++)if (v = m[s].getTime ? m[s].x.getTime() : m[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                    v > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))if ("number" !== typeof m[s].y) 0 < s && !w && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = k.nullDataLineDashType) : (d(y), y = [])), w = !0; else {
                    v = a.axisX.convertValueToPixel(v);
    ...
    A.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                c = this.plotArea, f = 0, g, h, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                var m = a.dataSeriesIndexes[c], p = this.data[m], e = p.dataPoints;
                if (0 < e.length)for (var r = 5 < n && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                    ...
                    var q = a.axisX.reversed ? g - n << 0 : g + n << 0, s;
                    0 <= e[f].y ? s = k : (s = h, h = k);
                    h > s && (b = h, h = s, s = b);
                    ...
                    this._eventManager.objectMap[b] = {
                        id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f,
                        x1: g, y1: h, x2: q, y2: s
                    };
                    b = G(b);
                    ...
                    (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        dataPoint: e[f],
                        dataSeries: p,
                        point: {x: g + (q - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? h : s},
                        direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1,
                        bounds: {x1: g, y1: Math.min(h, s), x2: q, y2: Math.max(h, s)},
                        color: b
                    })
                }
            }
    ...
    A.prototype.renderStackedColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var e = a.dataSeriesIndexes[n], r = this.data[e], q = r.dataPoints;
                if (0 < q.length) {
                    var s = 5 < p && r.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() :
                        ...
                        if (a.axisY.logarithmic) h[b] = q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : m, f[b] = k); else if (k = a.axisY.convertValueToPixel(q[l].y), 0 <= q[l].y) {
                            var t = f[b] ? f[b] : 0;
                            k -= t;
                            y = m - t;
                            f[b] = t + (y - k)
                        ...
                        (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: q[l],
                            dataSeries: r,
                            point: {x: c, y: 0 <= q[l].y ? k : y},
                            direction: 0 > q[l].y === a.axisY.reversed ? 1 :
                                -1,
                            bounds: {x1: v, y1: Math.min(k, y), x2: w, y2: Math.max(k, y)},
                            color: b
                        })
                    }
                }
    ...
    A.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var e =
                    a.dataSeriesIndexes[n], r = this.data[e], q = r.dataPoints;
                if (0 < q.length)for (var s = 5 < p && r.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
    ...
    A.prototype.renderBar =
        function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, c = this.plotArea, f = 0, g, h, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
                isFinite(n) ||
                ...
                for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                    ...
                    if (0 < e.length) {
                        ...
                        d.strokeStyle = "#4572A7 ";
                        for (f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            var q = a.axisX.reversed ? h - n << 0 : h + n << 0, s;
                            0 <= e[f].y ? s = k : (s = g, g = k);
                            b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
                            ...
                            this._eventManager.objectMap[b] = {
                                ...
                                dataPointIndex: f, x1: s, y1: h, x2: g, y2: q
                            };
                            b = G(b);
                            ...
                            (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: e[f],
                                dataSeries: p,
                                point: {x: 0 <= e[f].y ? g : s, y: h + (q - h) / 2},
                                direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(s, g), y1: h, x2: Math.max(s, g), y2: q},
                                color: b
                            })
                        }
                    }
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < q.length) {
                    ...
                    for (l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() :
                            q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), v = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = v + p << 0, y;
                        if (a.axisY.logarithmic) h[b] = q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : m, f[b] = k = a.axisY.convertValueToPixel(h[b])); else if (k = a.axisY.convertValueToPixel(q[l].y), 0 <= q[l].y) {
                            var t = f[b] ? f[b] : 0;
                            y = m + t;
                            k += t;
                            f[b] = t + (k - y)
                        ...
                        (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: q[l],
                            dataSeries: r,
                            point: {x: 0 <= q[l].y ? k : y, y: c},
                            direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1,
                            bounds: {
                                x1: Math.min(y,
                                    k), y1: v, x2: Math.max(y, k), y2: w
                            },
                            color: b
                        })
                    }
    ...
    A.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            ...
            u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip());
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var e = a.dataSeriesIndexes[n], r = this.data[e],
                    q = r.dataPoints;
                if (0 < q.length) {
                    var s = 5 < p && r.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        ...
                        this._indexLabels.push({
                            ...
                            dataPoint: q[l],
                            dataSeries: r,
                            point: {x: 0 <= q[l].y ? k : v, y: c},
                            direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: Math.min(v, k), y1: w, x2: Math.max(v, k), y2: y},
                            color: b
                        })
                    }
                }
    ...
    A.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var m = a.dataSeriesIndexes[k], n = this.data[m], p = n.dataPoints, h = n.id;
                this._eventManager.objectMap[h] = {objectType: "dataSeries", dataSeriesIndex: m};
                h = G(h);
                c.fillStyle = h;
                var h = [], e = !0, r = 0, q, s, v, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    y, t = null;
                if (0 < p.length) {
                    var D = n._colorSet[r % n._colorSet.length], x = n.lineColor = n.options.lineColor || D, aa = x;
                    b.fillStyle = D;
                    b.strokeStyle = x;
                    b.lineWidth = n.lineThickness;
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = I(n.nullDataLineDashType, n.lineThickness), z = n.lineDashType, R = I(z, n.lineThickness);
                        b.setLineDash(R)
                    }
                    for (var J = !0; r < p.length; r++)if (v = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !J)))if ("number" !== typeof p[r].y) n.connectNullData ||
                    (J || e) || d(), J = !0; else {
                        ...
                        0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < n.markerSize) && (v = n.getMarkerProperties(r, q, s, b), l = v.color, h.push(v), H = G(H), u && h.push({
                            x: q, y: s, ctx: c, type: v.type, size: v.size, color: H, borderColor: H,
        ...
        function (a) {
            function d() {
                ...
                if (0 < d.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var e = 0; e < d.length - 3; e += 3)if (b.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), u && c.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle || d[e + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[e + 3].x, d[e +
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    h = G(h);
                    c.fillStyle = h;
                    var h = [], e = 0, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v, w = null, y = [];
                    if (0 < p.length) {
                        var t = n._colorSet[e % n._colorSet.length], D = n.lineColor = n.options.lineColor || t, x = D;
                        b.fillStyle =
                            t;
                        b.strokeStyle = D;
                        b.lineWidth = n.lineThickness;
                        ...
                        for (q = !1; e < p.length; e++)if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !q)))if ("number" !== typeof p[e].y) 0 < e && !q && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
                                A, z = n.nullDataLineDashType) : (d(), y = [])), q = !0; else {
                            ...
                            if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < n.markerSize)) {
                                var J = n.getMarkerProperties(e, r, q, b), l = J.color;
                                h.push(J);
                                R = G(R);
                                u && h.push({
                                    x: r,
    ...
    A.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                h = G(h);
                c.fillStyle = h;
                var h = [], e = !0, r = 0, q, s, v, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, t = null, D = !1;
                if (0 < p.length) {
                    var x = n._colorSet[r % n._colorSet.length], z = n.lineColor = n.options.lineColor || x, A = z;
                    b.fillStyle = x;
                    b.strokeStyle = z;
                    b.lineWidth = n.lineThickness;
                    var B = "solid";
                    if (b.setLineDash) {
                        var R =
                            I(n.nullDataLineDashType, n.lineThickness), B = n.lineDashType, J = I(B, n.lineThickness);
                        b.setLineDash(J)
                    }
                    for (; r < p.length; r++)if (v = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !D))) {
                        var H = s;
    ...
    A.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = [], g = null, h = this.plotArea, l = [], k = [], m = [], n = [], p = 0, e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v = this._eventManager.ghostCtx;
            u && v.beginPath();
            b.save();
            u && v.save();
            b.beginPath();
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        q = m[p];
                        var H = null, H = 0 <= t.dataPointIndexes[q] ? D[t.dataPointIndexes[q]] : {x: q, y: null};
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(),
                            J = !0; else {
    ...
    A.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = this.plotArea, g = [], h = null, l = [], k = [], m = [], n = [], p = 0, e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v = this._eventManager.ghostCtx;
            b.save();
            u && v.save();
            b.beginPath();
            b.rect(f.x1, f.y1, f.width, f.height);
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                k = [];
                if (0 < m.length) {
                    var c = t._colorSet[p % t._colorSet.length], z = t.lineColor = t.options.lineColor || c, A = z;
                    b.fillStyle = c;
                    b.strokeStyle = z;
                    b.lineWidth = t.lineThickness;
                    var B = "solid";
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        q = m[p];
                        var H = null, H = 0 <= t.dataPointIndexes[q] ? x[t.dataPointIndexes[q]] : {x: q, y: null};
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            (!t.connectNullData || !J)))if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(), J = !0; else {
                            var ea;
    ...
    A.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, l = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var m = a.dataSeriesIndexes[k], n = this.data[m],
            ...
            for (var r = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)if (m = a.dataSeriesIndexes[k], n = this.data[m], p = n.dataPoints, 0 < p.length)for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++)if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin ||
                ...
                var e = p[c].z, q = 2 * Math.max(Math.sqrt((h === l ? b / 2 : r + (b - r) / (h - l) * (e - l)) / Math.PI) << 0, 1), e = n.getMarkerProperties(c, d);
                e.size = q;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, p = 0, c = 0; c < m.length; c++)if (f = m[c].getTime ? f = m[c].x.getTime() : f = m[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[c].y) {
                        f = a.axisX.convertValueToPixel(f);
    ...
    A.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                var r = a.dataSeriesIndexes[e], q = this.data[r], s = q.dataPoints;
                if (0 < s.length)for (var v = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? n = s[f].x.getTime() : n = s[f].x, !(n < a.axisX.dataInfo.viewPortMin ||
                    ...
                    var w = g - p / 2 << 0, y = w + p << 0, c = s[f].color ? s[f].color : q._colorSet[0], t = Math.round(Math.max(1, 0.15 * p)), x = 0 === t % 2 ? 0 : 0.5, z = q.dataPointIds[f];
                    ...
                    (s[f].indexLabel || q.indexLabel || s[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        dataPoint: s[f],
                        dataSeries: q,
                        point: {x: w + (y - w) / 2, y: a.axisY.reversed ? k : l},
                        direction: 1,
                        bounds: {x1: w, y1: Math.min(l, k), x2: y, y2: Math.max(l, k)},
                        color: c
                    })
                }
            }
    ...
    A.prototype.renderRangeColumn = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = 0, g, h, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                var m =
                    a.dataSeriesIndexes[k], n = this.data[m], p = n.dataPoints;
                if (0 < p.length)for (var e = 5 < l && n.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                    ...
                    var r = a.axisX.reversed ? b + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount +
                        k) * l << 0 : b - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + k) * l << 0, q = a.axisX.reversed ? r - l << 0 : r + l << 0, b = p[f].color ? p[f].color : n._colorSet[f % n._colorSet.length];
                    if (c > g) {
                        var s = c, c = g;
                        g = s
                    }
                    ...
                    if (p[f].indexLabel || n.indexLabel || p[f].indexLabelFormatter ||
                        ...
                        dataSeries: n,
                        indexKeyword: 0,
                        point: {x: r + (q - r) / 2, y: p[f].y[1] >= p[f].y[0] ? g : c},
                        direction: p[f].y[1] >= p[f].y[0] ? -1 : 1,
                        bounds: {x1: r, y1: Math.min(c, g), x2: q, y2: Math.max(c, g)},
                        color: b
                    }), this._indexLabels.push({
                        chartType: "rangeColumn",
                        dataPoint: p[f],
                        dataSeries: n,
                        indexKeyword: 1,
                        point: {x: r + (q - r) / 2, y: p[f].y[1] >= p[f].y[0] ? c : g},
                        direction: p[f].y[1] >= p[f].y[0] ? 1 : -1,
                        bounds: {x1: r, y1: Math.min(c, g), x2: q, y2: Math.max(c, g)},
                        color: b
                    })
    ...
    A.prototype.renderRangeBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                var n = a.dataSeriesIndexes[m], p = this.data[n], e = p.dataPoints;
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)if (e[f].getTime ?
                        ...
                        if (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                            ...
                            point: {
                                x: e[f].y[1] >=
                                e[f].y[0] ? c : g, y: h + (q - h) / 2
                            },
                            direction: e[f].y[1] >= e[f].y[0] ? -1 : 1,
                            bounds: {x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: q},
                            color: b
                        }), this._indexLabels.push({
                            chartType: "rangeBar",
                            dataPoint: e[f],
                            dataSeries: p,
                            indexKeyword: 1,
                            point: {x: e[f].y[1] >= e[f].y[0] ? g : c, y: h + (q - h) / 2},
                            direction: e[f].y[1] >= e[f].y[0] ? 1 : -1,
                            bounds: {x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: q},
                            color: b
                        })
    ...
    A.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = [], k = a.dataSeriesIndexes[h], m = this.data[k], n = m.dataPoints, f = m.id;
                this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                f = G(f);
                c.fillStyle = f;
                var f = [], p = !0, e = 0, r, q, s, v, w = null;
                if (0 < n.length) {
                    var y =
                        m._colorSet[e % m._colorSet.length], t = m.lineColor = m.options.lineColor || y, x = t;
                    b.fillStyle = y;
                    b.strokeStyle = t;
                    ...
                    for (var E = !0; e < n.length; e++)if (v = n[e].x.getTime ? n[e].x.getTime() : n[e].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !E)))if (null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                        ...
                        p || E ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = B, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), u && c.lineTo(r, q), l.push({
                                    x: r,
                                    y: s
                                })) : (b.beginPath(), b.moveTo(r, q), w = {x: r, y: q}, l = [], l.push({
                                    x: r,
                                    y: s
    ...
    A.prototype.renderRangeSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            u && (c.beginPath(), c.rect(h.x1, h.y1, h.width, h.height), c.clip());
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h], k = this.data[l], m = k.dataPoints, f = k.id;
                ...
                var f = [], n = 0, p, e, r, q = [], s = [];
                if (0 < m.length) {
                    var v = k._colorSet[n % k._colorSet.length], w = k.lineColor = k.options.lineColor || v, y = w;
                    b.fillStyle = v;
                    b.lineWidth = k.lineThickness;
                    var t = "solid", x;
                    if (b.setLineDash) {
                    ...
                    for (e = !1; n < m.length; n++)if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !e)))if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                        ...
                        if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < k.markerSize)) {
                            var B = k.getMarkerProperties(n, p, e, b), g = B.color;
                            f.push(B);
                            var E = G(A);
                            u && f.push({
                                x: p,
    ...
    A.prototype.renderPie = function (a) {
        function d() {
            if (m && n) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < n.length; f++) {
                    ...
                    r.push(l);
                    var p = {percent: null, total: null}, q = null, p = k.getPercentAndTotal(m, g);
        ...
        function b(a) {
            ...
            for (b = 0; b < n.length; b++) {
                var c = r[b].startAngle, d = r[b].endAngle;
                if (d > c) {
                    var f = 0.07 * B * Math.cos(r[b].midAngle), g = 0.07 * B * Math.sin(r[b].midAngle), l = !1;
                    if (n[b].exploded) {
        ...
        function f(a) {
            for (var b = null, d = 1; d < n.length; d++)if (b = (a + d + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) {
                b = null;
                break
            } else if (r[b].indexLabelText && b !== a && (0 > c(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y :
                    r[b].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function g(a, b, d) {
            ...
            if (0 <= a && a < n.length) {
                ...
                k = null;
                for (l = 1; l < n.length; l++)if (k = (a - l + r.length) % r.length, r[k].hemisphere !== r[a].hemisphere) {
                    k = null;
                    break
                } else if (r[k].indexLabelText && r[k].hemisphere === r[a].hemisphere && k !== a && (0 > c(r[k], r[a]) || ("right" === r[a].hemisphere ? r[k].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y : r[k].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y)))break; else k = null;
                m = k;
                p = f(a);
                l = k = 0;
        ...
        function h() {
            ...
            for (var b = a = 0, d = 0, l = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                ...
                } else for (a = 0; a < n.length; a++)h = r[a], s = "pie" === m.type ? 0.7 * B : 0.8 * B, x = t.x + s * Math.cos(h.midAngle), u = t.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = u;
                    ...
                    n.length; g++)if (e = !1, w = r[g], w.indexLabelText) {
                        ...
                        if (null !== h) {
                            ...
                            if (l = 0 > z) {
                                ...
                                var m = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height / 2, q = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height / 2, s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2, t = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width, v = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
        ...
        var k = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var m = this.data[a.dataSeriesIndexes[0]], n = m.dataPoints, p = 10, e = this.plotArea, r = [], q = 2, s, v = 1.3, w = 20 / 180 * Math.PI, y = 6, t = {
                x: (e.x2 + e.x1) / 2,
                y: (e.y2 + e.y1) / 2
            }, u = 0;
            a = !1;
            for (var A = 0; A < n.length; A++)u += Math.abs(n[A].y), !a && ("undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length) && (a = !0),
            !a && ("undefined" !== typeof n[A].label && null !== n[A].label && 0 < n[A].label.toString().length) && (a = !0);
            if (0 !== u) {
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                    ...
                    for (b = 0; b < n.length; b++) {
                        var c = 0 === b ? r[b].startAngle : d, d = c + (r[b].endAngle - r[b].startAngle), f = !1;
                        d > a && (d = a, f = !0);
    ...
    W.prototype._getLineWithWidth = function (a, d, b) {
        ...
        for (this.ctx.font = this._getFontString(); c <= f;) {
            ...
            if (b < d) c = g + 1; else if (b > d) f = g - 1; else break
        }
    ...
    wa.prototype.render = function () {
        ...
        for (var n =
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? $.getDefaultLegendMarker(p.type) : p.markerType, r = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this.options,
                            dataSeries: p,
                            dataPoint: null
                        }) : p.name, q = p.legendMarkerColor =
                    p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : p._colorSet[0], s = p.markerSize || "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type ? 0.75 * this.lineHeight : 0, v = p.legendMarkerBorderColor ? p.legendMarkerBorderColor : p.markerBorderColor, w = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, r = this.chart.replaceKeywordsWithValue(r, p.dataPoints[0], p, n), e = {
                    markerType: e,
                    markerColor: q,
                    text: r,
                    textBlock: null,
                ...
                k.push(e)
            } else for (var u = 0; u < p.dataPoints.length; u++) {
                var t = p.dataPoints[u], e = t.legendMarkerType ? t.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : $.getDefaultLegendMarker(p.type), r = t.legendText ? t.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                chart: this.chart,
                                legend: this.options,
                                dataSeries: p,
                                dataPoint: t
                            }) : t.name ? t.name : "DataPoint: " + (u + 1), q =
                    t.legendMarkerColor ? t.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : t.color ? t.color : p.color ? p.color : p._colorSet[u % p._colorSet.length], s = 0.75 * this.lineHeight, v = t.legendMarkerBorderColor ? t.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : t.markerBorderColor ? t.markerBorderColor : p.markerBorderColor, w = t.legendMarkerBorderThickness ? t.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : t.markerBorderThickness || p.markerBorderThickness ?
                            Math.max(1, Math.round(0.2 * s)) : 0, r = this.chart.replaceKeywordsWithValue(r, t, p, u), e = {
                    markerType: e,
                    markerColor: q,
                    text: r,
                    textBlock: null,
                ...
                if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width + s + l + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p =
                            {items: [], width: 0}, m.push(p), this.height += u, u = 0;
    ...
    $.prototype.getDataPointAtX = function (a, d) {
        ...
        var b = {
            ...
            distance: Infinity,
            index: NaN
        }, c = null, f = 0, g = 0, h = 1, l = Infinity, k = 0, m = 0, n = 0;
    ...
    $.prototype.getDataPointAtXY = function (a, d, b) {
        ...
        b = b || !1;
        var c = [], f = 0, g = 0, h = 1, l = !1, k = Infinity, m = 0, n = 0, p = 0;
        "none" !==
        ...
        for (; ;) {
            g = 0 < h ? p + f : p - f;
            if (0 <= g && g < this.dataPoints.length) {
                var e = this.chart._eventManager.objectMap[this.dataPointIds[g]], r = this.dataPoints[g], q = null;
                if (e) {
                    switch (this.type) {
                        case "column":
                        case "stackedColumn":
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = L("markerSize", r, this) || 4, v = b ? 20 : s, q = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2));
                            q <= v && c.push({dataPoint: r, dataPointIndex: g, dataSeries: this, distance: q});
                            g = Math.abs(e.x1 - a);
                            g <= k ? k = g : 0 < h ? m++ : n++;
                            q <= s / 2 && (l = !0);
                            break;
    ...
    B.prototype.createLabels = function () {
        var a, d, b = 0, c = 0, f, g = 0, h = 0, c = 0, l = this.interval, k = 0, m, n = 0.6 * this.chart.height, b = !1;
        if (this.dataSeries &&
            0 < this.dataSeries.length)for (c = 0; c < this.dataSeries.length; c++)"dateTime" === this.dataSeries[c].xValueType && (b = !0);
        if ("axisX" === this.type && b && !this.logarithmic)for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), f = Ha(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ha(b, l, this.intervalType))a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart, axis: this.options, value: b,
            ...
            if (this.labels) {
                a = Math.ceil(l);
                for (var l = Math.ceil(this.intervalStartPosition), p = !1, b = l; b < this.viewportMaximum; b += a)if (this.labels[b]) p = !0; else {
                    p = !1;
                    break
                }
        ...
        f = [];
        p = l = 0;
        if (this.labelAutoFit || this.options.labelAutoFit)if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle %
                360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)if (g = 0.9 * k >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            b = 0;
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a = this._labels[b].textBlock, r = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock, d = d.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
        ...
        } else for (b = 0; b < this._labels.length; b++)a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = x(this.options.labelFontSize) ? this.sessionVariables.labelFontSize :
        ...
        } else for (b = 0; b < this._labels.length; b++)a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this.options.labelMaxWidth) ?
    ...
    B.setLayoutAndRender = function (a, d, b, c, f, g) {
        var h, l, k, m, n = a[0] ? a[0].chart : d[0].chart, p = n.ctx;
        ...
        var r = 0, q = 0, s = 0, v = 0, w = 0, u = 0, t = 0, z, A, B = l = 0, E, F, G, J;
        E = F = G = J = !1;
        if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && a[e].title && (a[e]._titleTextBlock = new W(a[e].ctx, {
            text: a[e].title,
            horizontalAlign: "center",
        ...
        if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && d[e].title && (d[e]._titleTextBlock = new W(d[e].ctx, {
            text: d[e].title,
            horizontalAlign: "center",
        ...
        if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e] && b[e].title && (b[e]._titleTextBlock = new W(b[e].ctx, {
            text: b[e].title,
            horizontalAlign: "center",
        ...
        if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && c[e].title && (c[e]._titleTextBlock = new W(c[e].ctx, {
            text: c[e].title,
            horizontalAlign: "center",
        ...
        if ("normal" === f) {
            ...
            if (d && 0 < d.length)for (e = 0; e < d[e].length; e++)d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ?
            ...
            if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.height, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.width : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle =
                90);
            for (; 4 > r;) {
                var N = 0, Q = 0, P = 0, O = 0, L = f = 0, C = 0, S = 0, X = 0, V = 0, U = 0, T = 0;
                if (b && 0 < b.length)for (u = [], e = U = 0; e < b.length; e++)u.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), U += u[e], C += b[e] ? b[e].margin : 0; else u.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                M.push(u);
                if (c && 0 < c.length)for (t = [], e = T = 0; e < c.length; e++)t.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)), T += t[e], S += c[e] ? c[e].margin : 0; else t.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                K.push(t);
                h = Math.round(g.x1 + U + C);
                k = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S);
                if (a && 0 < a.length)for (v = [], e = X = 0; e < a.length; e++)a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(k - h), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width), v.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), X += v[e], f += a[e] ? a[e].margin : 0; else v.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                    0));
                H.push(v);
                if (d && 0 < d.length)for (w = [], e = V = 0; e < d.length; e++)d[e] && (d[e].lineCoordinates = {}), d[e].lineCoordinates.width = Math.abs(k - h), d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.width ? d[e].titleMaxWidth : d[e].lineCoordinates.width), w.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() : 0)), V += w[e], L += d[e] ? d[e].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                I.push(w);
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e].lineCoordinates.x1 = Math.round(g.x1 + U + C), d[e].lineCoordinates.x2 = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S), d[e].lineCoordinates.width = Math.abs(k - h), d[e]._labels && 1 < d[e]._labels.length && (m = d[e]._labels[1], l = "dateTime" === d[e].chart.plotInfo.axisXValueType ? d[e]._labels[d[e]._labels.length - 2] : d[e]._labels[d[e]._labels.length - 1], q = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) +
                    ...
                    x1: h, y1: l + (V + L - w[e] - Q), x2: k, y2: m, width: k -
                    h, height: m - l
                }, Q += w[e] + d[e].margin;
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, l = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {
                    x1: k - P, y1: l, x2: k - P, y2: m, height: Math.abs(m -
                        l)
                }, b[e].bounds = {
                    x1: h - (u[e] + P),
                    y1: l,
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(h), C = c[e]._labels && 0 < c[e]._labels.length ? c[e]._labels[c[e]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + V + L < Math.max(C,
                ...
                if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && (a[e].calculateValueToPixelConversionParameters(),
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e].calculateValueToPixelConversionParameters(), d[e]._labels && 1 < d[e]._labels.length && (z =
                ...
                if (0 < r) {
                    if (a && 0 < a.length)for (e =
                                                   0; e < a.length; e++)E = H[r - 1][e] === H[r][e] ? !0 : !1; else E = !0;
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)F = I[r - 1][e] === I[r][e] ? !0 : !1; else F = !0;
                    if (b && 0 < b.length)for (e = 0; e < b.length; e++)G = M[r - 1][e] === M[r][e] ? !0 : !1; else G = !0;
                    if (c && 0 < c.length)for (e = 0; e < c.length; e++)J = K[r - 1][e] === K[r][e] ? !0 : !1; else J = !0
                }
                if (E && F && G && J)break;
                r++
            }
            ...
            p.clip();
            if (a && 0 <
                a.length)for (e = 0; e < a.length; e++)a[e].renderLabelsTicksAndTitle();
            ...
            I = [];
            M = [];
            if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ?
                0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle = -90);
            if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ? 0.8 * g.height : 1.5 * d[e].titleFontSize, d[e]._titleTextBlock.angle = 90);
            if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e] && b[e].title && (b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.width, b[e]._titleTextBlock.maxHeight = b[e].titleWrap ? 0.8 * g.height : 1.5 * b[e].titleFontSize, b[e]._titleTextBlock.angle =
                0);
            if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.width, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.height : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle = 0);
            for (; 4 > r;) {
                ...
                I.push(B);
                if (d && 0 < d.length)for (q =
                                               [], e = V = 0; e < d.length; e++)q.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), V += q[e], L += d[e] ? d[e].margin : 0; else q.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                M.push(q);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), k = Math.round(g.x2 - V - L > n.width - 10 ? n.width - 10 : g.x2 - V - L), b[e].labelAutoFit && !x(v) && (0 < !a.length && (h = 0 > b[e].labelAngle ? Math.max(h, v) : 0 === b[e].labelAngle ? Math.max(h, v / 2) : h), 0 < !d.length && (k = 0 < b[e].labelAngle ? k - w / 2 : 0 === b[e].labelAngle ?
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), k = Math.round(g.x2 - V - L > c[e].chart.width - 10 ? c[e].chart.width - 10 : g.x2 - V - L), c[e] && c[e].labelAutoFit && !x(u) && (0 < !a.length && (h = 0 < c[e].labelAngle ? Math.max(h, u) :
                ...
                if (b && 0 < b.length)for (z = [], e = O = 0; e < b.length; e++)z.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += z[e] + b[e].margin, C += b[e].margin; else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() :
                    0));
                s.push(z);
                if (c && 0 < c.length)for (A = [], e = U = 0; e < c.length; e++)A.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() : 0)), U += A[e], S += c[e].margin; else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                H.push(A);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)0 < b[e]._labels.length && (m = b[e]._labels[0], l = b[e]._labels[b[e]._labels.length - 1], v = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                ...
                if (n.panEnabled)for (e = 0; e < b.length; e++)z[e] = n.sessionVariables.axisY.height; else for (e = 0; e < b.length; e++)n.sessionVariables.axisY.height = z[e];
                if (b && 0 < b.length)for (e = b.length - 1; 0 <= e; e--)l = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = l - (z[e] + b[e].margin + N), b[e].lineCoordinates.y2 = l - (z[e] + b[e].margin + N), b[e].bounds = {
                    x1: h, y1: l - (z[e] + N + b[e].margin),
                    x2: k, y2: m - (N + b[e].margin), width: k - h, height: z[e]
                ...
                if (c && 0 < c.length)for (e = c.length - 1; 0 <= e; e--)c[e] && (l = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = m, c[e].lineCoordinates.y2 = m, c[e].bounds = {
                    x1: h,
                    y1: l + (c[e].margin + Q),
                    x2: k,
                    y2: m,
                ...
                if (a && 0 < a.length)for (e = 0; e < a.length; e++) {
                    ...
                    if (b && 0 < b.length)for (C = 0; C < b.length; C++)b[C] && b[C].labelAutoFit && (k = 0 > b[C].labelAngle ? Math.max(k, v) : 0 === b[C].labelAngle ? Math.max(k, v / 2) : k, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? k - X : h);
                    if (c && 0 < c.length)for (C = 0; C < c.length; C++)c[C] && c[C].labelAutoFit && (k = c[C].lineCoordinates.x1, h = k - X);
                    a[e].lineCoordinates = {x1: k - K, y1: l, x2: k - K, y2: m, height: Math.abs(m - l)};
                    a[e].bounds = {
                        x1: k - (B[e] + K), y1: l, x2: k, y2: m, width: k -
                        h, height: m - l
                    };
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++) {
                    ...
                    if (b && 0 < b.length)for (C = 0; C < b.length; C++)b[C] && b[C].labelAutoFit && (k = 0 > b[C].labelAngle ? Math.max(k, v) : 0 === b[e].labelAngle ? Math.max(k, v / 2) : k, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? k - V : h);
                    if (c && 0 < c.length)for (C = 0; C < c.length; C++)c[C] && c[C].labelAutoFit && (k = c[C].lineCoordinates.x2, h = k - V);
                    d[e].lineCoordinates =
                        {x1: k + P, y1: l, x2: k + P, y2: m, height: Math.abs(m - l)};
                    d[e].bounds = {x1: h, y1: l, x2: k, y2: m, width: k - h, height: m - l};
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].calculateValueToPixelConversionParameters();
                if (0 < r) {
                    if (a && 0 < a.length)for (e = 0; e < a.length; e++)E = I[r - 1][e] === I[r][e] ? !0 : !1; else E = !0;
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)F = M[r - 1][e] === M[r][e] ? !0 : !1; else F = !0;
                    if (b && 0 < b.length)for (e = 0; e < b.length; e++)G = s[r - 1][e] === s[r][e] ? !0 : !1; else G = !0;
                    if (c && 0 < c.length)for (e = 0; e < c.length; e++)J = H[r - 1][e] === H[r][e] ? !0 : !1; else J = !0
                }
                if (E && F && G && J)break;
                r++
            }
        ...
        if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].renderStripLinesOfThicknessType("value");
        ...
        if (b && 0 <
            b.length)for (e = 0; e < b.length; e++)b[e].renderGrid();
        if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].renderGrid();
    ...
    B.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (h)for (h = !1, c = 0; c < k.length; c++)b = k[c], b.stripLine.showOnTop ?
                h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
    ...
    B.prototype.calculateAxisParameters =
        function () {
            if (this.logarithmic) this.calculateLogarithamicAxisParameters(); else {
                ...
                if ("axisX" === this.type) {
                    if (this.dataSeries && 0 < this.dataSeries.length)for (f = 0; f < this.dataSeries.length; f++)"dateTime" === this.dataSeries[f].xValueType && (b = !0);
                ...
                if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.range)) {
                    ...
                    if (2 < d)for (b = 0; b < d - 2; b++)this.valueFormatString += "#"
                }
            }
        };
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    f = [];
                    if (this.chart.axisX)for (var l =
                        0; l < this.chart.axisX.length; l++) {
                        for (var h = this.chart.axisX[l].convertPixelToValue({y: d}), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++)(k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k));
                        k = null
                    }
                    ...
                    f = [];
                    if (this.chart.axisX)for (l = 0; l < this.chart.axisX.length; l++)for (h = this.chart.axisX[l].convertPixelToValue({x: a}), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++)(k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k));
                    if (this.chart.axisX2)for (l = 0; l < this.chart.axisX2.length; l++)for (h =
                                                                                                 this.chart.axisX2[l].convertPixelToValue({x: a}), k = null, c = 0; c < this.chart.axisX2[l].dataSeries.length; c++)(k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[l].dataSeries[c], null !== k.dataPoint.y && f.push(k))
                }
                ...
                if (k = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex =
                    k.dataPointIndex, this.currentSeriesIndex = k.dataSeries.index; else if (u)if (k = La(a, d, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    k = {};
                    if (0 <= this.currentDataPointIndex) c = f.dataPoints[this.currentDataPointIndex], k.dataSeries = f, k.dataPoint = c, k.index = this.currentDataPointIndex, k.distance = Math.abs(c.x - h); else {
                    ...
                    if (!x(k.dataPoint.y))if (k.dataSeries.axisY)if (0 < k.dataPoint.y.length) {
    ...
    S.prototype.getToolTipInnerHTML = function (a) {
        ...
        a = "";
        for (var h = !0, l = 0; l < d.length; l++)if (d[l].dataSeries.toolTipContent || d[l].dataPoint.toolTipContent) {
            h = !1;
            break
        }
        if (h && (this.content && "function" === typeof this.content ||
            ...
            entries: d
        }, b = this.contentFormatter ? this.contentFormatter(d) : this.content(d); else if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
            for (var k = null, m = "", l = 0; l < d.length; l++)if (c = d[l].dataSeries, f = d[l].dataPoint, g = d[l].index, a = "", 0 === l && (h && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? m += "undefined" !== typeof this.chart.axisX[0].labels[f.x] ? this.chart.axisX[0].labels[f.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length &&
    ...
    A.prototype.getPercentAndTotal = function (a, d) {
        ...
        if (0 <= a.type.indexOf("stacked")) c = 0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], f = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c)); else if ("pie" === a.type || "doughnut" === a.type) {
    ...
    A.prototype.replaceKeywordsWithValue = function (a, d, b, c, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do {
                ...
                if (b.percentFormatString) k = b.percentFormatString; else {
                    var k = "#,##0.", m = Math.max(Math.ceil(Math.log(1 /
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            if (d.hasOwnProperty(a)) h = d; else if (b.hasOwnProperty(a)) h = b; else return "";
            h = h[a];
            null !== e && (h = h[e]);
            if ("x" === a)if ("dateTime" === g.plotInfo.axisXValueType || "dateTime" === b.xValueType || d.x && d.x.getTime) {
            ...
            } else return da(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo); else return "y" === a ? da(h, d.yValueFormatString ? d.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########",
    ...
    la.prototype.fireEvent = function (a, d, b) {
        if (a && d) {
            var c = a.eventParameter, f = a.eventContext, g = a.eventContext.userContext;
    ...
    Da.prototype.animate = function (a, d, b, c, f) {
        ...
        b && this.animations.push({
            ...
            (a ? a : 0), duration: d, animationCallback: b, onComplete: c
        });
        for (a = []; 0 < this.animations.length;)if (d = this.animations.shift(), b = (new Date).getTime(), c = 0, d.startTime <= b && (c = f(Math.min(b - d.startTime, d.duration), 0, 1, d.duration), c = Math.min(c, 1), isNaN(c) || !isFinite(c)) && (c = 1), 1 > c && a.push(d), d.animationCallback(c), 1 <= c && d.onComplete) d.onComplete();
        this.animations = a;
    ...
    var F = {
        ...
        Chart: A, addColorSet: function (a, d) {
            ha[a] = d
